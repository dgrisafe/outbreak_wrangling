...
Let's save this data without mistakes in incubation timeline for the remaining discussions.
...
Note, the arguements "pattern" and "replacement" are in a specific order, and as long as we keep it straight we can save ourselves some time by not typing out the argument names.
...
No we have 4 unique hospitals as well as an "other" category, for a total of 5 distinct categories.
...
If you look carefully, we call the arguement `ordered`. This allows us to keep the same order when doing analysis later. I chose to do this here because I want the "other" level to be at the end. I arbitrarily chose alphabetical order for the named hospitals.
...
<!-- Use factors to make categories, ordinal factors with “other” at end -->
