...
- <a
  href="#23-creating-a-factor-variable-from-cases-of-another-factor-with-dplyrcase_when"
  id="toc-23-creating-a-factor-variable-from-cases-of-another-factor-with-dplyrcase_when">2.3
  Creating a factor variable from cases of another factor with
  <code>dplyr::case_when()</code></a>
...
# 2.3 Creating a factor variable from cases of another factor with `dplyr::case_when()`
...
![](map_ebola_2.2.png) ![](map_ebola_2.3.png)
